...
function Form() {
    ...
    return (
        <form className={`${styles.formStyle} w-100`} action="https://gmail.us1.list-manage.com/subscribe/post?u=5ae2ce452370c52c253ad0cf3&amp;id=697427cdf6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form">
